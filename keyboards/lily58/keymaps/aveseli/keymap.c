...
qk_tap_dance_action_t tap_dance_actions[] = {
    // simple tap dance
    [TD_UM_A] = ACTION_TAP_DANCE_DOUBLE(KC_A, KC_B), // replace with your keycodes. BASIC codes only, no custom codes.
};
 ...
 * `-----------------------------------------/       /     \      \-----------------------------------------'
 *                   | LGUI | LAlt |Space | / LOWER /       \RAISE \  |Enter | RAlt | RCTL |
 *                   |      |      |      |/       /         \      \ |      |      |      |
 *                   `----------------------------'           '------''--------------------'
 */
 [_QWERTY] = LAYOUT(
  ...
  KC_LSFT,       KC_Z,   KC_X,    KC_C,    KC_V,    KC_B, KC_DEL,  KC_BSPC,   KC_N,    KC_M, KC_COMM,  KC_DOT,  KC_SLSH, KC_RSFT,
                                KC_LGUI, KC_LALT, KC_SPC,     LOWER,  RAISE,        KC_ENT,  KC_RALT, KC_RCTL
),
...
[_LOWER] = LAYOUT(
  ...
  _______, KC_WWW_BACK, KC_WWW_FORWARD, _______, _______, _______, _______, _______, KC_MINS, KC_PLUS, KC_LCBR, KC_RCBR, KC_PIPE, _______,
...
[_RAISE] = LAYOUT(
  ...
  _______,   KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,                    KC_HOME, KC_PGDN, KC_PGUP,  KC_END, KC_PSCR, _______,
  _______,   KC_F6,   KC_F7,   KC_F8,   KC_F9,  KC_F10,                    KC_LEFT, KC_DOWN,   KC_UP, KC_RGHT,  KC_INS, _______,
  _______,  _______, _______, _______, KC_F11,  KC_F12, _______, _______,  KC_MINS, KC_EQL,  KC_LBRC, KC_RBRC, KC_BSLS, _______,
                              _______, _______, _______, _______, _______,  _______, _______, _______
),
 ...
 * |      |      |      |      |      |      |-------|    |-------|      |      |      |      |      |      |
 * `-----------------------------------------/       /     \      \-----------------------------------------'
*                    | LOpt | LCmd |Space | / LOWER /       \RAISE \  |Enter | RCmd |      |
 *                   |      |      |      |/       /         \      \ |      |      |      |
 *                   `----------------------------'           '------''--------------------'
 */
...
[_MAC] = LAYOUT(
  ...
  _______, _______, _______, _______, _______, _______,                    _______, _______, _______, _______, _______, _______,
  _______,  _______, _______, _______,_______, _______, _______, _______,  _______, _______, _______, _______, _______, _______,
                             KC_LOPT, KC_LCMD, _______, _______, _______,  _______, KC_RCMD, _______
),
 ...
 * |      |      |      |      |      |      |                    |      |      |      |      |      |      |
 * |------+------+------+------+------+------|                    |------+------+------+------+------+------|
 * |      |GAMING|  MAC |      |      |      |-------.    ,-------|      |RGB MP|RGB ON| HUE+ | SAT+ | VAL+ |
 * |------+------+------+------+------+------|       |    |       |------+------+------+------+------+------|
 * |      |      |      |      |      |      |-------|    |-------|      |      | MODE | HUE- | SAT- | VAL- |
 * `-----------------------------------------/       /     \      \-----------------------------------------'
 *                   | LGUI | LAlt |Space | / LOWER /       \RAISE \  |Enter | DEL  | RAlt |
 *                   |      |      |      |/       /         \      \ |      |      |      |
 *                   `----------------------------'           '------''--------------------'
 */
  [_ADJUST] = LAYOUT(
  ...
  XXXXXXX,  GAMING,     MAC, XXXXXXX, XXXXXXX, XXXXXXX,                   XXXXXXX, RGB_M_P, RGB_TOG, RGB_HUI, RGB_SAI, RGB_VAI,
